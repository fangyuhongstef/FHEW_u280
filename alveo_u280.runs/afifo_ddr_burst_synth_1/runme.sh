...
HD_PWD='/home/fangyuhong/dma/alveo_u280/alveo_u280.runs/afifo_ddr_burst_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_ddr_burst.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_ddr_burst.tcl
