...
HD_PWD='/home/fangyuhong/dma/alveo_u280/alveo_u280.runs/int_ila_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log int_ila_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source int_ila_0.tcl
