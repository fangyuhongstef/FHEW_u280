...
#
# Generated by export_simulation on Thu Sep 21 15:20:11 CST 2023
#
################################################################################
...
'-reset_run' switch to the './int_ila_0.sh' script.

./int_ila_0.sh -reset_run
...
./int_ila_0.sh -noclean_files

For more information on the script, please type './int_ila_0.sh -help'.
