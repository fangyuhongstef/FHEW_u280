...
simulate()
{
  xsim  ila_1 -key {Behavioral:sim_1:Functional:ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_1120.protoinst" -protoinst "protoinst_files/bd_36b4.protoinst" -protoinst "protoinst_files/bd_2d80.protoinst" -protoinst "protoinst_files/u280_xdma.protoinst" -log simulate.log
}
